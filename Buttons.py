    ...
    def __init__(self, x: int, y: int, content, screen_height=None, screen_width=None) -> None:
        ...
        if isinstance(content, str):
            ...
            if screen_width and screen_height:
                ...
                self.image = pygame.transform.scale(self.image, (self.button_width+120, self.button_height+30))
...
class box_Button:
    ...
    def __init__(self, x: int, y: int, content, screen_height, screen_width) -> None:
        # Initialize font
        self.font = pygame.font.SysFont('Arial', 30)
        ...
        if isinstance(content, str):
            ...
            if screen_width and screen_height:
                ...
                self.button_height = self.image.get_height()
                # self.image = pygame.transform.scale2x(self.image)
                self.image = pygame.transform.scale(self.image, (self.button_width + 50, self.button_height + 50))
