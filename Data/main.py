...
grid_size_menu = 10
volume_value = 0.1
BG = pygame.image.load(r"images\assets\Background.png").convert_alpha()
...
pygame.mixer.music.set_volume(volume_value)  # Set the volume (0.0 to 1.0)
pygame.mixer.music.play(-1)  # Play the music in a loop

volume_slider = Slider((SCREEN.get_width()//2, 785), (500, 25), pygame.mixer.music.get_volume(), 0, 100)

def get_font(size):  # Returns Press-Start-2P in the desired size
    return pygame.font.Font(r"images\assets\font.ttf", size)
...
def main_menu():
    while True:
        ...
        INSTRACTION_IMG = pygame.image.load(r"images\assets\Options Rect.png").convert_alpha()
        INSTRACTION_IMG = pygame.transform.scale(INSTRACTION_IMG, (950, 110))
        

        PLAY_BUTTON = Button_menue(image=pygame.image.load(r"images\assets\Play Rect.png"), pos=(SCREEN.get_width()//2, SCREEN.get_height()//2), text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="green")
        OPTIONS_BUTTON = Button_menue(image=pygame.image.load(r"images\assets\Options Rect.png"), pos=(SCREEN.get_width()//2, SCREEN.get_height()//2 + 120), text_input="OPTIONS", font=get_font(75), base_color="#d7fcd4", hovering_color="green")
        QUIT_BUTTON = Button_menue(image=pygame.image.load(r"images\assets\Quit Rect.png"), pos=(SCREEN.get_width()//2, SCREEN.get_height()//2 + 360), text_input="QUIT", font=get_font(75), base_color="#d7fcd4", hovering_color="green")
